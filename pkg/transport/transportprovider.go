...
func GetTransportProvider(ctx context.Context, name string) (interfaces.TransportProvider, error) {
	...
	return nil, mperror.ErrTransportProviderNotFound
}

func GetTransportProviders(ctx context.Context) []interfaces.TransportProvider {
	transportsMutex.Lock()
	defer transportsMutex.Unlock()
	var a []interfaces.TransportProvider
